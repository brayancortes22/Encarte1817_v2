...
{
    /// <summary>
    /// DTO para mostrar información básica de un cliente
    /// </summary>
    public class ClientDto : BaseDto
    {
        ...
        [StringLength(10, ErrorMessage = "El número de vía no puede exceder 10 caracteres")]
        public string ShippingStreetNumber { get; set; }

        public StreetLetter ShippingStreetLetter { get; set; }

        [StringLength(20, ErrorMessage = "El número secundario no puede exceder 20 caracteres")]
        public string ShippingSecondaryNumber { get; set; }

        public UnitType ShippingUnitType { get; set; }

        [StringLength(10, ErrorMessage = "El número de unidad no puede exceder 10 caracteres")]
